...
def get_all_items_combined():
    ...
    """
    try:
        from treasury_signals.scanners.regulatory_scanner import get_all_regulatory_from_db
...
def get_all_statements_combined():
    ...
    """
    try:
        from treasury_signals.scanners.regulatory_scanner import get_all_statements_from_db
